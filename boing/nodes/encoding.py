...
from boing.core.MappingEconomy import \
    HierarchicalProducer, HierarchicalConsumer, Node, FunctionalNode
...
class OscLogFile(QtCore.QObject, HierarchicalConsumer):
...
class OscLogPlayer(HierarchicalProducer):
    """
